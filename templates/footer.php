    ...
    <!-- place footer here -->
    <br>
    <footer class="footer mt-auto py-0 bg-dark text-white">
      <div class="container">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top text-white">
          <div class="col-md-4 d-flex align-items-center">
            ...
            <div class="mb-3 mb-md-0 text-white" >
                <h5>Hora: <span id="tiempo"> 00 : 00 : 00 </span></h5>
            </div>
  ...
  <script src="<?php echo $url_base?>assets/js/reloj.js"></script>


  <!-- script para crear tablas con filtros y paginados -->
