...
if($_POST){
  ...
  $sentencia=$conexion->prepare("UPDATE tbl_empleados SET primernombre=:primernombre, segundonombre=:segundonombre, primerapellido=:primerapellido,
  segundoapellido=:segundoapellido, idcargo=:idpuesto, fechaingreso=:fechaingreso WHERE id=:id");
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <br>
            <img width="100" src="<?php echo $foto;?>" class="img-fluid rounded"/><br>
            <br>
          ...
          <div class="mb-3">
              ...
              <select class="form-select form-select-lg" name="idpuesto" id="idpuesto">
                <?php foreach($lista_tbl_puestos as $registro) {?> 
                      <option <?php echo ($idpuesto==$registro['id'])?"selected":"";?> value="<?php echo $registro["id"];?>"><?php echo $registro["nombrepuesto"];?></option> 
                <?php } ?>
              </select>
          </div>
          <div class="mb-3">
            <label for="fechadeingreso" class="form-label">Fecha de ingreso: </label>
            <input type="date" value="<?php echo $fechaingreso?>" class="form-control" name="fechadeingreso" id="fechadeingreso" aria-describedby="emailHelpId">
